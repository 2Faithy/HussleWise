...
const Sidebar = ({ userData, isOnline = true, onToggle }) => {
  ...
  const businessItems = [
    ...
    },
    {
      ...
      icon: FiTrendingUp,
      path: "/grants",
      description: "Monitor applications & Expert guidance",
      premium: userData?.plan === "Free",
    },
    {
      id: "growth-coach",
  ...
  return (
    <>
      ...
      {isMobile && isMobileOpen && (
        <div className="hw-mobile-overlay" onClick={toggleMobileSidebar} />
      )}

      {/* Sidebar */}
      <aside
        className={`hw-sidebar ${shouldShowCollapsed ? "collapsed" : ""} ${
        ...
        <div className="hw-sidebar-scrollable">
          ...
          <div className="hw-sidebar-header">
            <div className="hw-logo">
              <h2
                className={`hw-logo-text ${
                  shouldShowCollapsed ? "hidden" : ""
                }`}
              >
            ...
            {/* Connection Status */}
            <div
              className={`hw-connection-status ${
              ...
              {!shouldShowCollapsed && (
                <div className="hw-user-details">
                  ...
                  <div className="hw-user-stats">
                    <span
                      className={`hw-user-plan plan-${userData.plan?.toLowerCase()}`}
                    >
          ...
          <nav className="hw-sidebar-nav">
                    ...
                    >
                      ...
                      {!shouldShowCollapsed && (
                        <div className="hw-nav-content">
                          ...
                          <span className="hw-nav-description">
                            {item.description}
                          </span>
                        </div>
                      )}
                      ...
                      {item.highlight && (
                        <div className="hw-highlight-dot"></div>
                      )}
                    </button>
                  </li>
                );
            ...
            <div className="hw-nav-section">
              {!shouldShowCollapsed && (
                <h4 className="hw-section-title">Business Growth</h4>
              )}
              <ul className="hw-nav-list">
                        ...
                        {!shouldShowCollapsed && (
                          <div className="hw-nav-content">
                            <span className="hw-nav-label">
                              {item.label}
                              {item.premium && (
                                <span className="hw-pro-tag">PRO</span>
                              )}
                            </span>
                            <span className="hw-nav-description">
                              {item.description}
              ...
              <div className="hw-today-summary">
                ...
                <div className="hw-summary-stats">
                  <div className="hw-stat">
                    ...
                    <span className="hw-stat-value hw-positive">
                      ₦{userData.todaySummary.sales?.toLocaleString()}
                    </span>
                  </div>
                  <div className="hw-stat">
                    <span className="hw-stat-label">Net Profit</span>
                    <span
                      className={`hw-stat-value ${
                        userData.todaySummary.profit >= 0
                          ? "hw-positive"
                          : "hw-negative"
                      }`}
                    >
            ...
            {userData?.plan === "Free" && !shouldShowCollapsed && (
              <div className="hw-upgrade-banner">
                <div className="hw-upgrade-content">
                  ...
                  <p>
                    Unlock AI insights, unlimited receipts & marketplace
                    priority
                  </p>
                  <button
