    ...
    <div className="home-page">
      ...
      <section className="hero" style={{ backgroundColor: "#ECBC94" }}>
        <div className="hero-content" data-aos="fade-right">
          ...
          <p>
            Simple tools for Nigerian entrepreneurs to track money, grow sales,
            and get official
          </p>
          ...
          {[
            {
              ...
              text: "See all money in and out at a glance",
            },
            {
              icon: <MdPointOfSale size={32} />,
              title: "Sales Records",
              text: "Log sales in seconds",
            },
            {
              icon: <FiUsers size={32} />,
              title: "Customer Management",
              text: "Track buyers and send receipts",
            },
            {
              icon: <FiFileText size={32} />,
              title: "CAC Registration",
              text: "Get your business registered easily",
            },
            {
              icon: <FaWhatsapp size={32} />,
              title: "WhatsApp Tools",
              text: "Send receipts and promotions",
            },
            {
              icon: <FaChartLine size={32} />,
              title: "Growth Insights",
              text: "AI-powered business advice",
            },
          ].map((feature, index) => (
            <div
              key={index}
      ...
      <section
        ...
        style={{ backgroundColor: "#0E1B1A", color: "white" }}
      >
      ...
      <section className="testimonials">
        ...
        <div className="testimonial-cards">
          {[
            {
              name: "Mama Nkechi",
              business: "Tomato Seller",
              quote: "My sales increased by 30% after using the insights",
            },
            {
              name: "Mr. Ade",
              business: "Tailor",
              quote: "The CAC registration saved me weeks of stress",
            },
            {
              name: "Amina",
              business: "Hair Stylist",
              quote: "My customers love the WhatsApp receipts",
            },
      ...
      <section className="pricing-section" style={{ background: "#ECBC94" }}>
        ...
        <p className="pricing-intro" data-aos="fade-up" data-aos-delay="100">
          Simple and affordable plans for every stage of your business.
        </p>
        <div className="pricing-cards">
          ...
          <div className="pricing-card" data-aos="fade-up" data-aos-delay="200">
            ...
            <ul>
              <li>
                <FiCheckCircle size={18} /> Daily sales tracking
              </li>
              <li>
                <FiCheckCircle size={18} /> 20 Customer records
              </li>
              <li>
                <FiCheckCircle size={18} /> Basic reports
              </li>
            </ul>
            <Link to="/signup">
          ...
          >
            ...
            <ul>
              <li>
                <FiCheckCircle size={18} /> Unlimited tracking
              </li>
              <li>
                <FiCheckCircle size={18} /> Unlimited customers
              </li>
              <li>
                <FiCheckCircle size={18} /> Advanced AI insights
              </li>
              <li>
                <FiCheckCircle size={18} /> WhatsApp integration
              </li>
              <li>
                <FiCheckCircle size={18} /> Priority support
              </li>
            </ul>
          ...
          <div className="pricing-card" data-aos="fade-up" data-aos-delay="400">
            ...
            <ul>
              <li>
                <FiCheckCircle size={18} /> All Pro features
              </li>
              <li>
                <FiCheckCircle size={18} /> Multiple users
              </li>
              <li>
                <FiCheckCircle size={18} /> Dedicated account manager
              </li>
              <li>
                <FiCheckCircle size={18} /> Custom integrations
              </li>
            </ul>
      ...
      <section
        className="cta"
        style={{ backgroundColor: "#1C5B56", color: "white" }}
      >
        <h2 data-aos="fade-up">Ready to Grow Your Business?</h2>
        <p data-aos="fade-up" data-aos-delay="100">
          Join thousands of Nigerian entrepreneurs using Business Companion
        </p>
